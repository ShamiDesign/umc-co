  ...
  return (
    <section className="mt-10 bg-gray-100 px-6 md:px-20">
      ...
      <div className="flex flex-col items-center  ">
        ...
        <p className="text-[14px] md:text-[16px] w-full md:w-3/4 text-center text-gray-600 leading-loose ">
          {t("Airports.body")}
        </p>
      </div>

      <div className="body flex flex-col items-center  ">
        <h3 className="text-[14px] md:text-[16px] py-4 font-medium ">
          {t("Airports.subtitle")}
        </h3>
          ...
          {Airpoarts.map((item, i) => (
            ...
            >
              ...
              {item.nameKey === "Airports.itemsAirPorts.airportName4" ? (
                ...
                <p className="text-lg font-semibold text-center">{t(item.nameKey)}</p>
              )}
            </Paper>
          ))}
        </div>
