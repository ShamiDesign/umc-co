      ...
      <div className="flex flex-wrap items-center justify-center mt-4 gap-6 mx-auto">
        {gairportsS.map((item, index) => (
          ...
          >
            ...
            {/* Overlay */}
            <div className="absolute inset-0 flex items-end bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
